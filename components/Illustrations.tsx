...
export function Logo({ size = 26 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 40 40" fill="none" aria-hidden="true">
      <circle cx="20" cy="20" r="18.5" stroke="#6FA83A" strokeWidth="1.6" />
      <path d="M20 24V15" stroke="#143424" strokeWidth="2.2" strokeLinecap="round" />
      <path d="M20 17c0-3.4 2.6-5.6 6-5.6 0 3.4-2.6 5.6-6 5.6Z" fill="#6FA83A" />
      <path d="M20 20c0-3-2.3-5-5.3-5 0 3 2.3 5 5.3 5Z" fill="#143424" />
      <path d="M13.5 24.5h13l-1.6 7.2a1.6 1.6 0 0 1-1.6 1.3h-6.6a1.6 1.6 0 0 1-1.6-1.3l-1.6-7.2Z" fill="#143424" />
    </svg>
  );
}
